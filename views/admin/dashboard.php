...
$monthRevenue    = $pdo->query("
    ...
    JOIN services s ON a.service_id = s.id 
    WHERE a.status = 'done' 
    AND MONTH(a.appt_date) = MONTH(CURDATE()) 
...
$pendingDeposits = $pdo->query("
    ...
    WHERE deposit_status = 'uploaded' AND status = 'confirmed'
")->fetchColumn();
  ...
  <div class="main-wrap">
    ...
    <div class="content-pad">
      <div class="mb-4">
        ...
        <p style="color:var(--text-muted);font-size:0.9rem;margin:0;">Overview of PawCare operations — <?= date('F j, Y') ?></p>
      </div>

      <!-- ✅ Alert: Pending Deposits -->
      <?php if ($pendingDeposits > 0): ?>
      <div style="background:#fff8e1;border:1px solid #ffe082;border-radius:var(--radius);padding:1rem 1.2rem;margin-bottom:1.5rem;display:flex;align-items:center;justify-content:space-between;gap:0.8rem;">
        ...
        <a href="appointments.php?status=confirmed" class="btn-primary-site btn-sm-site">Review Now</a>
      </div>
      <?php endif; ?>
      ...
      <div class="row g-3 mb-3">
        <div class="col-md-4">
          <div class="stat-card" style="border-left:4px solid #27ae60;">
            ...
            <div>
              <div class="stat-num" style="color:#27ae60;">₱<?= number_format($totalRevenue, 2) ?></div>
        ...
        <div class="col-md-4">
          <div class="stat-card" style="border-left:4px solid #2980b9;">
            ...
            <div>
              <div class="stat-num" style="color:#2980b9;">₱<?= number_format($monthRevenue, 2) ?></div>
        ...
        <div class="col-md-4">
          <div class="stat-card" style="border-left:4px solid #7c5c3e;">
            ...
            <div>
              <div class="stat-num" style="color:#7c5c3e;">₱<?= number_format($todayRevenue, 2) ?></div>
      ...
      <div class="row g-3 mb-4">
        ...
        $cards = [
            ...
            ['num' => $todayAppts,     'label' => "Today's Appointments", 'color' => '#2980b9', 'bg' => '#ebf5fb', 'icon' => 'M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z'],
            ...
            <div class="card-body-site" style="padding:1rem;">
              ...
              <div style="margin-bottom:1rem;">
                ...
                <div style="background:var(--gray-light);border-radius:10px;height:6px;">
                  <div style="background:var(--brown);border-radius:10px;height:6px;width:<?= round(($svc['total']/$maxTotal)*100) ?>%;transition:width 0.5s;"></div>
                </div>
    ...
    datasets: [
      {
        ...
        borderColor: 'rgba(124, 92, 62, 0.8)',
        borderWidth: 2,
        borderRadius: 6,
      },
      {
